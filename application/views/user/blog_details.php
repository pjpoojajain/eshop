                ...
                <div class="col-lg-12">
                    <div class="blog-details-inner">
                        ...
                        <div class="blog-large-pic">
                            <img src="<?php echo base_url();?>assests/img/blog/blog-detail.jpg" alt="">
                        </div>
                        ...
                        <div class="blog-more">
                            <div class="row">
                                <div class="col-sm-4">
                                    <img src="<?php echo base_url();?>assests/img/blog/blog-detail-1.jpg" alt="">
                                </div>
                                <div class="col-sm-4">
                                    <img src="<?php echo base_url();?>assests/img/blog/blog-detail-2.jpg" alt="">
                                </div>
                                <div class="col-sm-4">
                                    <img src="<?php echo base_url();?>assests/img/blog/blog-detail-3.jpg" alt="">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-5 col-md-6">
                                    <a href="#" class="prev-blog">
                                        <div class="pb-pic">
                                            ...
                                            <img src="<?php echo base_url();?>assests/img/blog/prev-blog.png" alt="">
                                        </div>
                                        <div class="pb-text">
                                ...
                                <div class="col-lg-5 offset-lg-2 col-md-6">
                                    <a href="#" class="next-blog">
                                        <div class="nb-pic">
                                            <img src="<?php echo base_url();?>assests/img/blog/next-blog.png" alt="">
                        ...
                        <div class="posted-by">
                            <div class="pb-pic">
                                <img src="<?php echo base_url();?>assests/img/blog/post-by.png" alt="">
                            </div>
                            <div class="pb-text">
                                <a href="#">
                                    <h5>Shane Lynch</h5>
