            ...
            <div class="inner-header">
                <div class="row">
                    <div class="col-lg-2 col-md-2">
                        <div class="logo">
                            <a href="#">
                                <img src="<?php echo base_url();?>assests/img/header-eshop-logo.jpg" alt="">
                            </a>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        ...
                        <li><a href="#">Pages</a>
                            <ul class="dropdown">
                                <li><a href="<?php echo base_url(); ?>welcome/blog_details/">Blog Details</a></li>
                                <li><a href="<?php echo base_url(); ?>welcome/shopping_cart/">Shopping Cart</a></li>
